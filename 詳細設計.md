...
| No   | 処理内容                                 | URL<br/>（Front-end）                                        | 入力パラメータ                                               | controller                                | service                                                      | リクエストモデル | URI<br/>（MS）                                               | 戻り値判定                                                   | レスポンスモデル                                             | 備考 |
| ---- | ---------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ----------------------------------------- | ------------------------------------------------------------ | ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---- |
| 11   | プリセットマスタ取得処理レシート取得処理 | PresetMaster<br/> /PresetCatalogDetailsReceipt<br/> /FetchReceiptDetail | ・companyCode：企業コード（15桁）<br/> ・storeCode：店舗コード（6桁）<br/> ・planningCode：企画コード | getPresetCatalogDetailsfetchReceiptDetail | presetService.getPresetCatalogDetailsreceiptService.getReceiptDetail |                  | GET<br/> presets/catalog/{companyCode}/{storeCode}/{planningId}GET<br/> receiptplans/setting/{companyCode}/{storeCode}/{planningCode} | ■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:204･･･データなし（応答コード：2）<br/> ・statusCode:400･･･異常（応答コード：204）<br/> ・statusCode:上記以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー以外･･･異常（応答コード：-30）■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:200以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー･･･異常（応答コード：-20）<br/> ・以外･･･異常（応答コード：-30）<br/> ■オフライン（Back-end→MS）<br/> ・通信異常･･･異常（応答コード：-10） | PresetCatalogDetailResponse()FetchReceiptDetailResponseModel() |      |
| 22   | カタログ更新処理レシート更新処理         | PresetMaster<br/> /BarcodeAnalysisReceipt<br/> /UpdateReceiptDetail | ・companyCode：企業コード（15桁）<br/> ・storeCode：店舗コード（6桁）<br/> ・planningCode：企画コード<br/> ・headerLogoBase64EncodedString：ヘッダーロゴのBase64エンコード文字列<br/> ・headerLogoHashValue：ヘッダーロゴの値<br/> ・footerLogoBase64EncodedString：フッターロゴのBase64エンコード文字列<br/> ・footerLogoHashValue：フッターロゴの値<br/> ・revenueStampLogoBase64EncodedString：収益印ロゴのBase64エンコード文字列<br/> ・revenueStampLogoHashValue：収益印ロゴの値 | barcodeAnalyzeupdateReceiptDetail         | barcodeService.barcodeAnalysisreceiptService.updateReceiptDetail |                  | POST<br/> barcode-analysis/analyzeGET<br/> receiptplans/setting/{companyCode}/{storeCode}/{planningCode} | ■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:200以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー･･･異常（応答コード：-20）<br/> ・以外･･･異常（応答コード：-30）<br/> ■オフライン（Back-end→MS）<br/> ・通信異常･･･異常（応答コード：-10）■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:200以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー･･･異常（応答コード：-20）<br/> ・以外･･･異常（応答コード：-30）<br/> ■オフライン（Back-end→MS）<br/> ・通信異常･･･異常（応答コード：-10） | BarcodeAnalysisResponse()FetchReceiptDetailResponseModel()   |      |
| 33   | プリセットマスタ登録処理レシート削除処理 | PresetMaster<br/> /RegisterReceipt<br/> /DestroyReceiptDetail | ・companyCode：企業コード（15桁）<br/> ・storeCode：店舗コード（6桁）<br/> ・planningCode：企画コード | registdestroyReceiptDetail                | presetService.createPresetCatalogDetailsreceiptService.destroyReceiptDetail |                  | POST<br/> presets/catalog/DELETE<br/> receiptplans/setting/{companyCode}/{storeCode}/{planningCode} | ■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:204･･･データなし（応答コード：2）<br/> ・statusCode:上記以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー以外･･･異常（応答コード：-30）■オンライン正常<br/> ・statusCode:200･･･正常（応答コード：0）<br/> ・statusCode:204･･･異常（応答コード：2）<br/> ・statusCode:上記以外･･･異常（応答コード：statusCode）<br/> ■オンライン異常<br/> ・JSON変換エラー･･･異常（応答コード：-20）<br/> ・以外･･･異常（応答コード：-30）<br/> ■オフライン（Back-end→MS）<br/> ・通信異常･･･異常（応答コード：-10） | PresetCatalogDetailResponse()FetchReceiptDetailResponseModel() |      |

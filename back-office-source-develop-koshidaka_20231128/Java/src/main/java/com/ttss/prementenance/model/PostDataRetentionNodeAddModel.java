 ...
 */
@Data
public class PostDataRetentionNodeAddModel {
	...
	private PostDataRetentionNodeAddnodeRetentionsModel nodeRetentions = new PostDataRetentionNodeAddnodeRetentionsModel();

 ...
 */
@RestController
@RequestMapping("StoreGroup2Master")
public class StoreGroup2MasterController {
	...
	@Autowired
	public StoreGroup2MasterController() {
	}
	...
	@PutMapping("/Update")
	@ResponseBody
	public PutStoreResponseModel storeGroup2MasterUpdate(
...
//		postNodesBodyModel.getRequestModel().getConfigurations().setSTORE_GROUP_2(model);
//KSD V001.000 20230904 DE
//KSD V001.000 20230904 AS
		Map<String, Object> model_wk = (Map<String, Object>)model.get("STORE_GROUP_2");
		postNodesBodyModel.getRequestModel().getConfigurations().setSTORE_GROUP_2(model_wk);
...
//////////////////////////////////////////////////////////////////////////////KOSHIDAKA debug
	...
	@CrossOrigin
	@PutMapping("/Delete")
	public PutStoreResponseModel storeGroup2MasterDeleted(
			@RequestBody @Validated Map<String, Object> model,
			Errors errors, HttpServletRequest request, HttpServletResponse response) {

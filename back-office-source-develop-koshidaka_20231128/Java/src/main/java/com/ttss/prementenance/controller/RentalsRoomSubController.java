 ...
 */
@RestController
@RequestMapping("RentalsRoomsub")
public class RentalsRoomSubController {
  ...
  @Autowired
  public RentalsRoomSubController() {}
  ...
  @ResponseBody
  public RentalsCommonResponseModel rentalsRoomSubQuery(@RequestBody @Validated Map<String, Object> model,
...
//KSD V001.000 20230810 AE
		...
		// POST要求（取得）
		////////////////////////////////
		responseModel = rentalsService.RentalsRoomSubQuery(paramReq, bodyReq,
...
//  public RentalsCommonResponseModel rentalsRoomSubUpdate(@RequestBody @Validated Map<String, Object> model,
//		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
//
//		var responseModel = new RentalsCommonResponseModel();
//KSD V001.000 20230816 DE
//KSD V001.000 20230816 AS
  public RentalsUpdateResponseModel rentalsRoomSubUpdate(@RequestBody @Validated Map<String, Object> model,
		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
...
//KSD V001.000 20230816 AE
		...
		// POST要求（更新）
		////////////////////////////////
		responseModel = rentalsService.RentalsRoomSubUpdate(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());

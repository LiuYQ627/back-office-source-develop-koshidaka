...
/**
 * pricelistレコード更新取消レスポンス データモデル.
 *
 * @author 
 * @version 1.0.0
 */
@Data
public class DeletePricelistsRecordPriceListRecordIdResponseModel {
	public DeletePricelistsRecordPriceListRecordIdResponseModel() {}

...
*/
@Service
public class DeleteS3storefolderService {

  @Autowired
  public DeleteS3storefolderService() {}
   ...
   */
  public PutStoreResponseModel postDeleteS3storefolder(
          String nodeId,
    ...
    try {
      ...
      // URLの生成
      var url = apiContext.getWso2CommonUrl() + apiContext.getDeletes3storefolder();
//////////////////////////////////////////////////////////////////////////////KOSHIDAKA debug
//    url = "http://localhost:8082/" + apiContext.getDeletes3storefolder();
//////////////////////////////////////////////////////////////////////////////KOSHIDAKA debug
      ...
      responseModel.setResult(ApiUtil
          .createExceptionResponseModel(messageResourseUtil.getMessage("F00003.E010"), -10, e));
    } catch (JsonProcessingException e) {
      // JSON変換エラー
      responseModel.setResult(ApiUtil
          .createExceptionResponseModel(messageResourseUtil.getMessage("F00003.E011"), -20, e));
    } catch (Exception e) {
      // 上記以外
      responseModel.setResult(ApiUtil
          .createExceptionResponseModel(messageResourseUtil.getMessage("F00003.E011"), -30, e));
    }
    return responseModel;
  }

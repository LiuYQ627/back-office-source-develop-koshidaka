 ...
 */
@RestController
@RequestMapping("RentalsRoomInformation")
public class RentalsRoomInformationController {
  ...
  @Autowired
  public RentalsRoomInformationController() {}
  ...
  @ResponseBody
  public RentalsCommonResponseModel rentalsRoomInformationQuery(@RequestBody @Validated Map<String, Object> model,
...
//KSD V001.000 20230810 AE
		...
		// POST要求（取得）
		////////////////////////////////
		responseModel = rentalsService.RentalsRoomInformationQuery(paramReq, bodyReq,
...
//  public RentalsCommonResponseModel rentalsRoomInfomationUpdate(@RequestBody @Validated Map<String, Object> model,
//		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
//
//		var responseModel = new RentalsCommonResponseModel();
//KSD V001.000 20230816 DE
//KSD V001.000 20230816 AS
  public RentalsUpdateResponseModel rentalsRoomInfomationUpdate(@RequestBody @Validated Map<String, Object> model,
		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
...
//KSD V001.000 20230816 AE
		...
		// POST要求（更新）
		////////////////////////////////
		responseModel = rentalsService.RentalsRoomInformationUpdate(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());
...
// KSD V001.000 20230922 AE
  ...
  @ResponseBody
  public RentalsCommonResponseModel rentalsRoomInfomationDelete(@RequestBody @Validated Map<String, Object> model,
		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
		...
		// POST要求
		////////////////////////////////
		responseModel = rentalsService.RentalsRoomInformationDelete(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());

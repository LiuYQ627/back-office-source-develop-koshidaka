 ...
 */
@RestController
@RequestMapping("RentalsWeekdayDivision")
public class RentalsWeekdayController {
  ...
  @Autowired
  public RentalsWeekdayController() {}
  ...
  @ResponseBody
  public RentalsCommonResponseModel rentalsWeekdayDivisionQuery(@RequestBody @Validated Map<String, Object> model,
		...
		try {
			...
			model.get("weekdayCode").hashCode();
		} catch (Exception e) {
			// エラーの場合
			responseModel.setResult(ApiUtil.getValidationErrorResponse(errors, messageSource));
			return responseModel;
...
//KSD V001.000 20230810 AE
		...
		// POST要求（取得）
		////////////////////////////////
		responseModel = rentalsService.RentalsWeekdayDivisionQuery(paramReq, bodyReq,
...
//  public RentalsCommonResponseModel rentalsWeekdayDivisionUpdate(@RequestBody @Validated Map<String, Object> model,
//		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
//
//		var responseModel = new RentalsCommonResponseModel();
//KSD V001.000 20230816 DE
//KSD V001.000 20230816 AS
  public RentalsUpdateResponseModel rentalsWeekdayDivisionUpdate(@RequestBody @Validated Map<String, Object> model,
		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
...
//KSD V001.000 20230816 AE
		...
		// POST要求（更新）
		////////////////////////////////
		responseModel = rentalsService.RentalsWeekdayDivisionUpdate(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());
...
// KSD V001.000 20230922 AE
  ...
  @ResponseBody
  public RentalsCommonResponseModel rentalsWeekdayDivisionDelete(@RequestBody @Validated Map<String, Object> model,
		  Errors errors, HttpServletRequest request, HttpServletResponse response) {
		...
		// POST要求
		////////////////////////////////
		responseModel = rentalsService.RentalsWeekdayDivisionDelete(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());

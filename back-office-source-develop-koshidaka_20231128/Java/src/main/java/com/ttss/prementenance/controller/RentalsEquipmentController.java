 ...
 */
@RestController
@RequestMapping("RentalsEquipment")
public class RentalsEquipmentController {
  ...
  @Autowired
  public RentalsEquipmentController() {}
   ...
   * 機材アイテム取得
   *
   * @param model リクエスト内容[nodeId,equipNo]
  ...
  public RentalsCommonResponseModel rentalsEquipmentQuery(@RequestBody @Validated Map<String, Object> model,
		...
		paramReq.getRequestModel().setOrderBy("equipNo");
...
//KSD V001.000 20230810 AE
		...
		if(model.get("equipNo").hashCode() !=0 ) 
		{
			ArrayList<Long> equipNoList= new ArrayList<Long>();
			equipNoList.add((long)model.get("equipNo").hashCode());
//KSD V001.000 20230810 DS
//			bodyReq.getRequestModel().getKeys().setEquipNo(equipNoList);
//KSD V001.000 20230810 DE
//KSD V001.000 20230810 AS
			bodyReq.getRequestModel().setEquipNo(equipNoList);
//KSD V001.000 20230810 AE
		}
		////////////////////////////////
		// POST要求（取得）
		////////////////////////////////
		responseModel = rentalsService.RentalsEquipmentQuery(paramReq, bodyReq,
...
//KSD V001.000 20230809 AE
		...
		// POST要求（更新）
		////////////////////////////////
		responseModel = rentalsService.RentalsEquipmentUpdate(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());
...
// KSD V001.000 20230922 AE
  ...
  public RentalsCommonResponseModel rentalsEquipmentDelete(@RequestBody @Validated Map<String, Object> model,
		...
		// POST要求
		////////////////////////////////
		responseModel = rentalsService.RentalsEquipmentDelete(model,
				messageSource, apiContext, accessToken, ELERAToken, loginUser.getBusinessUnitCdStr() + loginUser.getUserId(), loginUser.getPassWord());

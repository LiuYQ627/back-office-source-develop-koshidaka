...
<style scoped src="@/resource/static/css/StoreGroupOneRegistration/StoreGroupOneRegistration.css" />
<style src="./../../static/css/MasterCommon/masterCommon.css"></style>
<style scoped src="@/resource/static/css/StoreGroupOneRegistration/StoreGroupOneRegistration.css"></style>
<script type="text/javascript" src="./../../static/js/StoreGroupOneRegistration/storeGroupOneRegistration.js"></script>
<template>
  <v-container class="group-one-base-container-body baseContainer">
    <!-- (1)コード新規/ダイレクト編集エリア -->
    <v-row
      id="inputRow"
      align="center">
      ...
      <v-col class="bkColorBlue">
        <div class="underLine2">
          <input
            ...
            :placeholder="this.$i18n.t('F32251.S019')"
            maxlength="3"
    ...
    <v-row
      ...
      <v-col
        ...
        style="padding: 0px;">
        <label class="inputLabel">{{ $t("F32251.S002") }}</label>
        <div class="inline-radio">
          ...
          <div style="margin-left:10px"><input
            ...
            @change="onRadioChange"><label
              ...
              class="scrollNone">{{ $t("F32251.S004") }}</label></div>
        </div>
      </v-col>
      <v-col>
        <div class="underLine2">
    ...
    <v-row style="height: 38px;width: 680px;margin-top:-8px">
      <v-col style="text-align: left;">
        <font
          class="baseFont"
          style="font-size:20px;margin-left:-12px"><b style="font-weight:normal;">{{ $t("F32251.S005") }}{{ resultCount }}{{ $t("F32251.S006") }}</b></font>
      </v-col>
    </v-row>
    <v-row style="height: 30px;width: 680px;">
      <v-col
        :cols="4"
        style="padding: 0px;">
        <label id="ListHeader">{{ $t("F32251.S007") }}</label>
      </v-col>
      <v-col
        :cols="7"
        style="padding: 0px;">
        <label id="ListSplitHeader">{{ $t("F32251.S008") }}</label>
      </v-col>
      <v-col
        :cols="1"
        style="padding: 0px;">
        <label id="ListSplitHeader"><font style="margin-left:-21px">{{ $t("F32251.S009") }}</font></label>
      </v-col>
    </v-row>
    <v-row

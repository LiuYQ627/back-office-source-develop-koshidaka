...
<style scoped src="@/resource/static/css/CommonInput/radioButton.css" />
<script type="text/javascript" src="@/resource/static/js/EndButtonSetting/radioButton.js" />
  ...
  <v-row
    ...
    <v-col
      ...
      <button
        ...
        :class="{ checked: label.value === value }"
        @click="$emit('input', label.value)"
        :disabled="disabled"
      >
        {{ label.name }}
      </button>

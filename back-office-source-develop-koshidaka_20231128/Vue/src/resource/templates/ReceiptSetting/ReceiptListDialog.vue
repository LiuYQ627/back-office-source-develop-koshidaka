...
<script type="text/javascript" src="@/resource/static/js/ReceiptSetting/receiptListDialog.js" />
 <!--
 * ---------+---------------------+----------+--------------------------------
...
<template>
  <div>
    ...
    <!--<common-dialog
      ...
      :hasOKButton=false
    >-->
    <!-- Step1 G001.00.0 Update-End -->
    <!-- G002.00.0 Delete-End -->
    <!-- G002.00.0 Add-Start -->
    <common-dialog
      v-model="displayed"
      :title="$i18n.t('O00004.S040')"
      @clickBack="closeDialog"
      @clickOk="onClickOk"
      :width="1200"
          ...
          <tbody>
            ...
            <tr
              ...
              <td :colspan="daysDisplayInCalendar + 4">
                <table>
                  <!-- <template v-for="presetPlan in presetPlans"> -->

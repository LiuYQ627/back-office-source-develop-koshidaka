...
<script type="text/javascript" src="@/resource/static/js/RevenueStampSetting/configSelect.js" />
 ...
 * 20230103  dingxin(Neusoft)  G002.00.0  issue課題#1225を対応します.
 * 20230506  wangchunmei(Neusoft)  G003.00.0  issue課題#908を対応します.
-->
...
<template>
  <v-container class="mt-15">
    ...
    <!--<div v-if="isShowDatePart">-->
    <div v-if="targetStoreCodes.length > 0">

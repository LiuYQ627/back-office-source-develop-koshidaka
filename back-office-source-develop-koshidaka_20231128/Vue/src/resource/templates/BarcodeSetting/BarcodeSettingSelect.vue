<style src="@/resource/static/css/BarcodeSetting/barcodeSettingSelect.css" />
<style src="@/resource/static/css/CommonDesign/utils.css" />
<script type="text/javascript" src="@/resource/static/js/BarcodeSetting/barcodeSettingSelect.js" />
